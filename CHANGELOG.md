...
- Fix dependabot lib directory path from `anubis` to `anubis`

## [0.3.3] - 2025-11-13

### Fixed
- Update setup script to replace literal `anubis` path references
...
### Fixed
- Replace `anubis` placeholder with buildable `anubis` name
- Update setup script to rename `libs/anubis` instead of `libs/PACKAGE_NAME`
...
### Changed
- Directory structure uses `libs/anubis` instead of `libs/PACKAGE_NAME`
- All imports and references updated to use `@neoma/anubis`
...
[Unreleased]: https://github.com/shipdventures/neoma-anubis/compare/v0.4.2...HEAD
[0.4.2]: https://github.com/shipdventures/neoma-anubis/compare/v0.4.1...v0.4.2
[0.4.1]: https://github.com/shipdventures/neoma-anubis/compare/v0.4.0...v0.4.1
[0.4.0]: https://github.com/shipdventures/neoma-anubis/compare/v0.3.3...v0.4.0
[0.3.3]: https://github.com/shipdventures/neoma-anubis/compare/v0.3.2...v0.3.3
[0.3.2]: https://github.com/shipdventures/neoma-anubis/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/shipdventures/neoma-anubis/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/shipdventures/neoma-anubis/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/shipdventures/neoma-anubis/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/shipdventures/neoma-anubis/releases/tag/v0.1.0